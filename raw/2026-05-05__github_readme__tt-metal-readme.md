---
title: "tenstorrent/tt-metal — README"
source_type: "github_readme"
original_url: "https://github.com/tenstorrent/tt-metal/blob/main/README.md"
...
# tenstorrent/tt-metal — README

Source URL: https://github.com/tenstorrent/tt-metal/blob/main/README.md
...
- README references many tech_reports/* files that are individually high-value capture targets:
  matrix_engine, data_formats, reconfig_data_format, special_values, allocator, tensor_layouts,
  Saturating_DRAM_bandwidth, FlashAttention, CNNs/ttcnn, EthernetMultichip, Blackhole bring-up,
  SubDevices, Programming_Mesh_of_Devices, Programming_Multiple_Meshes, TT-Fabric, TT-Distributed,
  AdvancedPerformanceOptimizationsForModels, ViT-TTNN, LLMs, CNNs/cnn_optimizations, GEMM_FLOPS.
- METALIUM_GUIDE.md (linked) is a separate top-level capture target.
- Programming examples each have their own .md docs that are good ingest candidates for kernel patterns.
