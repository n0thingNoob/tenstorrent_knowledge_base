---
title: "tt-isa-documentation — Wormhole B0 overview"
source_type: "github_doc"
original_url: "https://github.com/tenstorrent/tt-isa-documentation/blob/main/WormholeB0/README.md"
...
Source URL: https://github.com/tenstorrent/tt-isa-documentation/blob/main/WormholeB0/README.md
...
- WebFetch returned only the first part of the page. The full README likely covers more (TLB descriptors, address space, harvesting, multicast, etc.) — re-fetch via raw.githubusercontent.com or git clone for full content.
- This page is the primary index into the Wormhole-architecture sub-tree. All linked subdirectories (TensixTile, DRAMTile, EthernetTile, PCIExpressTile, ARCTile, NoC) are individual high-priority capture targets.
- Diagram path `../Diagrams/Out/NoC_Layout.svg` not fetched as a binary; reference preserved.
