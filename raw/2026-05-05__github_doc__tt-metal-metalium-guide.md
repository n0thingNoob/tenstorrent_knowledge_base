---
title: "TT Architecture and Metalium Guide"
source_type: "github_doc"
original_url: "https://github.com/tenstorrent/tt-metal/blob/main/METALIUM_GUIDE.md"
...
Source URL: https://github.com/tenstorrent/tt-metal/blob/main/METALIUM_GUIDE.md
...
- This is the canonical TT-Metalium programming guide / architectural overview. Highest-priority source for understanding programming model.
- Many .webp images embedded; references preserved as relative paths under `docs/source/common/images/`.
- Cross-links to tech_reports/* (TT-Fabric, FlashAttention, GEMM_FLOPS, CNNs/ttcnn, EthernetMultichip, tensor_layouts) — separate capture targets.
- Code examples for reader/compute/writer kernels and Metalium host API are preserved verbatim — central reference for kernel coding patterns.
