---
title: "tt-isa-documentation — Wormhole NoC (Network on Chip)"
source_type: "github_doc"
original_url: "https://github.com/tenstorrent/tt-isa-documentation/blob/main/WormholeB0/NoC/README.md"
...
# Wormhole NoC (Network on Chip)

Source URL: https://github.com/tenstorrent/tt-isa-documentation/blob/main/WormholeB0/NoC/README.md
...
- Authoritative ISA-level reference for Wormhole NoC behavior — packet/flit format, virtual channels, request types (Read/Write/Atomic), broadcast semantics, deadlock freedom, ordering, performance numbers (9-cycle hop latency, 256-bit/flit throughput).
- Linked sub-pages all are separate capture targets: Atomics.md, Ordering.md, MemoryMap.md, Counters.md, RoutingPaths.md, Overlay/, plus L1.md / L1#atomics.
- Diagrams `NoC_0.svg` and `NoC_1.svg` referenced but not fetched as binaries.
- Cross-checks/contradicts corsix Part 3 (which measured 9-cycle tile-to-tile delay — confirmed here).
